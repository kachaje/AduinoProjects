...
NewSoftSerial mySerial4 =  NewSoftSerial(RxPinSet4, TxPinSet4);
...
PololuQik2 motorSet4 = PololuQik2(&mySerial4,ResetPinSet1,ErrorPinSet1,true, &crc);
int speed = 127;
int pos = 0;
...
void M6Forward(){
  motorSet4.motor0Forward(speed);
  Serial.println("M6 forward");
}

void M6Reverse(){
  motorSet4.motor0Reverse(speed);
  Serial.println("M6 reverse");
}

void M7Forward(){
  motorSet4.motor1Forward(speed);
  Serial.println("M7 forward");
}

void M7Reverse(){
  motorSet4.motor1Reverse(speed);
  Serial.println("M7 reverse");
}
